                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-300">
                            ...
                            Our goal is to have a positive effect on the wider Australian wine industry by introducing a new technology that brings verifiable trust.
                            We want to work with world renowned wine brands and bring their clients a different type of experience,
                            one that combines the rich traditional history of wine culture and the impending technological evolution that blockchain will bring with it.
                        </p>
                    </div>
